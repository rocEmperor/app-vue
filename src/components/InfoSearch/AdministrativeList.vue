<template>
  <div class="search-own">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>行政中心查询</el-breadcrumb-item>
    </el-breadcrumb>
...
<script>
  ...
  export default {
    name: 'SearchOwn',
    computed: mapState({
      model: state => state.AdministrativeListStore
    }),
    created: function () {
      this.$store.dispatch({
        type: 'AdministrativeListStore/reqData',
        payload: {
    ...
    methods: {
      paginationChange (current) {
        ...
        this.$store.commit({
          type: 'AdministrativeListStore/concat',
          payload: {
            currentPage: current
          }
        })
